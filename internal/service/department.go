...
func (ds departmentService) PatchDepartment(ctx context.Context, req dto.DepartmentReq, id string) (dto.DepartmentData, int, error) {
	department, err := ds.departmentRepository.FindById(ctx, id)
